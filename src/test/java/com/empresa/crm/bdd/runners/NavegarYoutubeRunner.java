...
@CucumberOptions(
    features = "src/test/resources/features/NavegarYoutube.feature", 
    glue = "com.empresa.crm.bdd.steps.youtube", 
    plugin = { "pretty", "html:target/report-html", "json:target/report.json" },
    monochrome = false,
    dryRun = false,
    strict = false    
    )
public class NavegarYoutubeRunner {
    private static final Logger logger = LoggerFactory.getLogger(NavegarYoutubeRunner.class);
