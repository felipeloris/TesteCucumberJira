...
@CucumberOptions(
    features = "src/test/resources/features/CalcExample.feature", 
...
public class CalcExampleRunner {
    private static final Logger logger = LoggerFactory.getLogger(CalcExampleRunner.class);
